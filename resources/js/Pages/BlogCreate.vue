              ...
              <div class="card-body">
                <form @submit.prevent="submitForm">
                  <div class="mb-3">
                    ...
                    <input type="text" id="title" class="form-control wide" v-model="formData.title" placeholder="Enter your blog title..." required>
                  </div>
                  <div class="mb-3">
                    <label for="content" class="form-label text-white">Content:</label>
                    <textarea id="content" class="form-control wide" v-model="formData.content" rows="10" placeholder="Write your blog post here..." required></textarea>
                  </div>
                  ...
                  <button type="submit" class="btn btn-primary btn-lg btn-block">Publish Blog Post</button>
                </form>
              </div>
            </div>
          </div>
